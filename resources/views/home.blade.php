...
<main class="pt-15">
    ...
    @if(isset($exclusiveServices) && $exclusiveServices->isNotEmpty())
    <!-- Balkis Exclusive Services Section -->
    <section id="exclusive-services" class="max-w-7xl mx-auto px-4 py-16 relative z-20 mt-8">
        <div class="text-center mb-12">
            <h3 class="text-3xl font-bold text-slate-800 mb-4 font-heading">{{ __('Balkis Exclusive Services') }}</h3>
            <div class="w-16 h-1 bg-gold-gradient mx-auto rounded-full mb-4"></div>
            <p class="text-slate-500 font-text max-w-2xl mx-auto">{{ __('Discover the exclusive services we offer to make your experience exceptional') }}</p>
        </div>
        ...
        <div class="relative group/slider">
            ...
            <div class="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-6 pb-6 -mx-4 px-4 sm:mx-0 sm:px-0">
                ...
                <div class="snap-start shrink-0 w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]">
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
