        ...
        <section class="mt-16 pt-12 border-t border-slate-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach($relatedTrips as $related)
                    <a href="{{ route('tourist_trips.show', ['locale' => app()->getLocale(), 'id' => $related->id]) }}" class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col group hover:shadow-lg transition-all duration-300">
